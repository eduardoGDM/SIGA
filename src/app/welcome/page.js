    ...
    return(
        <div className="h-screen justify-center items-center bg-[#251B45]">
             <img className="mx-auto my-auto p-[2%] " src="logo.svg" alt="image description"/>   
                ...
                <h1 className=" text-3xl">Bem-Vindo ao SIGA software</h1>
                <h2 className=" text-sm">Essa é a tela de configuração inicial do sistema.</h2>
        </div>
            <div className="flex justify-items-center items-center flex-col py-[3%] ">
                    ...
                    <h2 className="text-1xl py-[2%]">Faça o upload da logo/brasão da Instituição</h2>
