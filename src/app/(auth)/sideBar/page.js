...
export default function sideBar () {
    ...
    const Menu = [
        ...
        {title:"Gerenciar Relatórios",src:"/relatorio",link:"criarRelatorio"},
    ...
    return (
        ...
        <div className={`${open ? "w-72":"w-20"} duration-300 bg-[#251B45] h-screen relative pt-10 p-2` } >
         ...
         <div className="flex gap-x-4 items-center"  >
            ...
            <ul className="pt-6">
                {Menu.map((menu,index)=>(
                    <a href={menu.link} key={index} className="text-sm flex items-center gap-x-2 cursor-pointer py-[6%] px-[10%] rounded-xl hover:bg-[#0CCA98] ">
