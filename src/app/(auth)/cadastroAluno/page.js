  ...
  return (
    <div className="pl-[4%] pt-[4%]">
      ...
      <div className="">
        ...
        {alunos.map((aluno) => {
          return (
            <div className="grid grid-cols-4 gap-y-4 bg-slate-300 ">
              {" "}
              ...
              <h1>Pai: {aluno.pai}</h1>
              <button
                className="text-white font-bold bg-[#ca0c0c] rounded-lg text-1xl px-5 py-2 text-center inline-flex items-center mr-2 mb-[6%] "
                onClick={() => {
